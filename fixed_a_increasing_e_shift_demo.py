...
if __name__ == '__main__':
    ...
    shift_list = ["$e=0.98475$", "$e=0.98450$", "$e=0.98425$", "$e=0.98400$"] # Model training performed on descending shifts
    ...
    for i in range(0,len(inputdomain_list)):
        ...
        window_length = 5 # 50
        k = 5 # subspace rank
        Xsa, Xta, Ys, Yt = psa.streaming_procrustes_subspace_adaptation(X1,X_fromlist,Y1,Y_fromlist,t1,t_fromlist,window_length,k,interptype='time')
    ...
    fig0.savefig('plots/fixed_a_increasing_e_shifts_dataviz.pdf', format='pdf', bbox_inches='tight')
    fig1.savefig('plots/fixed_a_increasing_e_shifts_heatratevstime.pdf', format='pdf')
    fig2.savefig('plots/fixed_a_increasing_e_shifts_statespacecomparison.pdf', format='pdf', bbox_inches='tight')
    fig3.savefig('plots/fixed_a_increasing_e_shifts_statespaceprediction.pdf', format='pdf')