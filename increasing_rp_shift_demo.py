...
if __name__ == '__main__':
    ...
    fig0.savefig('plots/increasing_rp_shifts_dataviz.pdf', format='pdf', bbox_inches='tight')
    fig1.savefig('plots/increasing_rp_shifts_heatratevstime.pdf', format='pdf')
    fig2.savefig('plots/increasing_rp_shifts_statespacecomparison.pdf', format='pdf', bbox_inches='tight')
    fig3.savefig('plots/increasing_rp_shifts_statespaceprediction.pdf', format='pdf')