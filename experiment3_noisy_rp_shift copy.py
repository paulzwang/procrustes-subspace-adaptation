...
if __name__ == '__main__':
    ...
    for i in range(0,len(inputdomain_list)):
        ...
        if i < 4:
            ...
            # ax4[i,1].scatter(Hx_proj_aligned[0,:],Hx_proj_aligned[1,:],Hx_proj_aligned[2,:],s=4,marker='.',c=scolors,cmap='viridis',label='$X_a$',rasterized=True,depthshade=False)
            # ax4[i,1].scatter(Hz_proj[0,:],Hz_proj[1,:],Hz_proj[2,:],s=4,marker='.',c=tcolors,cmap='plasma',label='$Z_a$',rasterized=True,depthshade=False)
            ...
            # scolors = Hx_proj_aligned[2,:]
            # ax5[i-4,1].scatter(Hx_proj_aligned[0,:],Hx_proj_aligned[1,:],Hx_proj_aligned[2,:],s=4,marker='.',c=scolors,cmap='viridis',label='$X_a$',rasterized=True,depthshade=False)
            # ax5[i-4,1].scatter(Hz_proj[0,:],Hz_proj[1,:],Hz_proj[2,:],s=4,marker='.',c=tcolors,cmap='plasma',label='$Z_a$',rasterized=True,depthshade=False)
