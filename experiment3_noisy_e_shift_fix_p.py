...
if __name__ == '__main__':
    ...
    fig0.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_dataviz.pdf', format='pdf')
    fig1.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_heatratevstime.pdf', format='pdf')
    fig2.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_statespacecomparison.pdf', format='pdf')
    fig3.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_statespaceprediction.pdf', format='pdf')
    fig4.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_manifolds1.pdf', format='pdf')
    fig5.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_manifolds2.pdf', format='pdf')
    fig6.savefig('experimental_plots/noisy_data/noisy_fixed_p_decreasing_e_shifts_metrics.pdf', format='pdf')