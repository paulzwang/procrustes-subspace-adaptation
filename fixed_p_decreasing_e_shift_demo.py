...
if __name__ == '__main__':
    ...
    shift_list = ["$e=0.98225$", "$e=0.98250$", "$e=0.98275$", "$e=0.98300$"] # Model training performed on descending shifts
    ...
    fig0.savefig('plots/fixed_p_decreasing_e_shifts_dataviz.pdf', format='pdf', bbox_inches='tight')
    fig1.savefig('plots/fixed_p_decreasing_e_shifts_heatratevstime.pdf', format='pdf')
    fig2.savefig('plots/fixed_p_decreasing_e_shifts_statespacecomparison.pdf', format='pdf', bbox_inches='tight')
    fig3.savefig('plots/fixed_p_decreasing_e_shifts_statespaceprediction.pdf', format='pdf')