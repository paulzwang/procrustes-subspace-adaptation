...
if __name__ == '__main__':
    ...
    # mission2_data_directory = r'data\periapsis_shift\4orbit_ra=12000_rp=91.0\Results_ctrl=0_ra=12000_rp=91.0_hl=0.150_90.0deg.csv'
    ...
    # Subspace Alignment
    #=======================================================================================#
    Xsa_stream, Xta_seen, Ys_stream, Yt_seen, _, _, _, Hz_sub = psa.streaming_procrustes_subspace_adaptation(X1_seen,X2_seen,Y1_seen,Y2_seen,t1_seen,t2_seen,window_length=5,k=5,interptype='time',manifold_visual=True)
    ...
    fig1.savefig('plots/rp_shift_heatrate_vs_time.pdf', format='pdf')
    fig2.savefig('plots/rp_shift_state_space.pdf', format='pdf')
    fig3.savefig('plots/rp_shift_actualpred_state_space.pdf', format='pdf', bbox_inches='tight')