...
if __name__ == '__main__':
    ...
    # Subspace Alignment
    #=======================================================================================#
    Xsa_stream, Xta_seen, Ys_stream, Yt_seen, _, _, _ = psa.streaming_procrustes_subspace_adaptation(X1_seen,X2_seen,Y1_seen,Y2_seen,t1_seen,t2_seen,window_length=5,k=5,interptype='time')
    ...
    fig1.savefig('plots/fixed_a_e_shift_heatrate_vs_time.pdf', format='pdf')
    fig2.savefig('plots/fixed_a_e_shift_state_space.pdf', format='pdf')
    fig3.savefig('plots/fixed_a_e_shift_actualpred_state_space.pdf', format='pdf', bbox_inches='tight')